...
import { Pallet } from '../src/app/components/ServiceOne/Palett'
import { LogOne } from '../src/app/components/ServiceOne/LogOne'
import { PagVisual } from './PagVisual'

export function page() {
  return (
    <div className=" order-5 flex h-[794px] w-[1280px] flex-none  flex-grow-0 flex-row   items-center  justify-center gap-16 self-stretch ">
