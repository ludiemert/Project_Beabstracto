...
import { PhotoM } from './PhotoM'

export function ServiceOne() {
  return (
    <div className=" order-5 flex flex-none flex-grow-0 flex-row  items-center justify-center   gap-16  self-stretch p-[32px_0_32px_80px] lg:h-[794px] lg:w-[1280px]">
      <div className=" order-0 flex flex-none flex-col items-start justify-center gap-1 p-0 ">
        <Pallet />
        <h1 className="mb-1 mt-1 size-6 font-bold text-base-brand-primary-600 lg:h-[24px]   lg:w-[166px]">
          E o que a gente faz?
        </h1>
        <LogOne />

        <h2 className="order-3 flex-none flex-grow-0 font-proximaNova text-base leading-6 text-base-font-dark-800 lg:h-[96px] lg:w-[441px]">
      ...
      <div className=" order-1 flex flex-none flex-grow flex-col items-start justify-center gap-2 p-0 lg:h-[730px] lg:w-[494px]  ">
